...
import com.app.dao.IssueBookDao;
import com.app.dao.UserDao;
import com.app.entity.Book;
import com.app.entity.IssueBook;
...
public class Launch implements CommandLineRunner {
    ...
    public Launch(BookDao bookDao, IssueBookDao issueBookDao, UserDao userDao) {
...
//        int issueDays, double totalFee, double totalPenalty, boolean returned)
        long issueId = issueBookDao.saveIssueBook(new IssueBook(
        		bookId,userId,issuedDate,expectedSubmitDate,expectedSubmitDate,issueDays,totalFee,0,false));
